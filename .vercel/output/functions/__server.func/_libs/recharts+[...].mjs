...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$23(_objectSpread$23({}, offset), {}, _defineProperty$27({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$23(_objectSpread$23({}, offset), {}, _defineProperty$27({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		...
		return _objectSpread$23(_objectSpread$23({}, result), {}, _defineProperty$27({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$23(_objectSpread$23({}, res), {}, _defineProperty$27({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$23(_objectSpread$23({}, result), {}, _defineProperty$27({}, axisId, group));
	}, {});
};
/**
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
	...
	var result = PREFIX_LIST.reduce(function(res, entry) {
		return _objectSpread$13(_objectSpread$13({}, res), {}, _defineProperty$17({}, entry + camelName, value));
	}, {});
	result[name] = value;
	return result;
};
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		return _objectSpread$9(_objectSpread$9({}, result), {}, _defineProperty$13({}, id, finalAxis));
	}, {});
};
...
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$9(_objectSpread$9({}, res), {}, _defineProperty$13({}, key, ScaleHelper.create(options[key])));
	}, {});
...
*/
var ScatterChart = function generateCategoricalChart(_ref6) {
...
//#endregion
export { CartesianGrid as a, Scatter as i, YAxis as n, ResponsiveContainer as o, XAxis as r, Tooltip as s, ScatterChart as t };
