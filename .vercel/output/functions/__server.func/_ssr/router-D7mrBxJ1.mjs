...
//#region node_modules/.nitro/vite/services/ssr/assets/get-catalog-CHXB52Wr.js
...
var styles_default = "/assets/styles-DmlvUspa.css";
var APP_NAME = "Rassvet over Ukraine";
...
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Unofficial geometric coverage estimate of catalogued Rassvet objects over Ukraine from public orbit data."
			},
			{
				name: "theme-color",
				content: "#08090c"
...
function parseSearch(raw) {
	...
	return {
		...
		lon: num(raw.lon),
		el: num(raw.el),
		lang: raw.lang === "en" || raw.lang === "uk" || raw.lang === "ru" ? raw.lang : void 0,
		set: typeof raw.set === "string" ? raw.set : void 0,
		tz: raw.tz === "kyiv" || raw.tz === "utc" || raw.tz === "moscow" ? raw.tz : void 0,
		place: typeof raw.place === "string" ? raw.place : void 0
	};
}
var Route$3 = createFileRoute("/")({
	validateSearch: (search) => parseSearch(search),
	loader: async () => {
		return {
...
var rootRouteChildren = {
	...
	ConstellationRoute: Route$2.update({
		id: "/constellation",
		path: "/constellation",
		getParentRoute: () => Route$4
	}),
